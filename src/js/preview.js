...
(function initThree() {
    webgl.container = document.getElementById("preview__canvas");
    ...
    // webgl.texture = webgl.loader.load('/build/img/home/kizo.png', setup); 
...
function setup() {
    ...
    if (webgl.phase == "wall") {
        callTOaction();
        document.getElementById("preview").addEventListener("click", brakeWall, false);
        startWallAnimation();
    }
...
function brakeWall(e) {
    ...
    document.getElementById("preview").removeEventListener("click", brakeWall, false);
    webgl.tl.play();
}
